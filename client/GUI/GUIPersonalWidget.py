...
class GUIPersonalWidget_2 (QtWidgets.QWidget):
    def __init__(self, id_widget, path_icon_edit, parent=None):
        ...
        self.horizontalFrame.setMinimumSize(QtCore.QSize(0, 90))
        ...
        self.label_LPersPhoto = QtWidgets.QLabel(self.horizontalFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_LPersPhoto.sizePolicy().hasHeightForWidth())
        ...
        self.horizontalLayout_5.addWidget(self.label_LPersPhoto)
        spacerItem12 = QtWidgets.QSpacerItem(7, 40, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_5.addItem(spacerItem12)
        self.VLay_Name_LPers = QtWidgets.QFrame(self.horizontalFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.VLay_Name_LPers.sizePolicy().hasHeightForWidth())
        self.VLay_Name_LPers.setStyleSheet("background-color: rgb(217, 217, 217);")
        self.VLay_Name_LPers.setSizePolicy(sizePolicy)
        self.VLay_Name_LPers.setObjectName("VLay_Name_LPers_3")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.VLay_Name_LPers)
        ...
        self.Label_LPersLastName.setFont(font)
        self.Label_LPersLastName.setAlignment(QtCore.Qt.AlignCenter)
        self.Label_LPersLastName.setObjectName("Label_LPersLastName_3")
        self.verticalLayout_10.addWidget(self.Label_LPersLastName)
        self.Label_LPersName = QtWidgets.QLabel(self.VLay_Name_LPers)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.SP_Meanval = QtWidgets.QSplitter(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SP_Meanval.sizePolicy().hasHeightForWidth())
        self.SP_Meanval.setSizePolicy(sizePolicy)
        self.SP_Meanval.setOrientation(QtCore.Qt.Vertical)
        self.SP_Meanval.setObjectName("SP_Meanval_6")
        self.label_name_Meanval = QtWidgets.QLabel(self.SP_Meanval)
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(9)
        self.label_name_Meanval.setFont(font)
        self.label_name_Meanval.setObjectName("label_name_Meanval_6")
        self.label_Meanval = QtWidgets.QLabel(self.SP_Meanval)
        font = QtGui.QFont()
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.label_Meanval.setFont(font)
        self.label_Meanval.setObjectName("label_Meanval_6")
        self.horizontalLayout_4.addWidget(self.SP_Meanval)
        self.SP_Lastval = QtWidgets.QSplitter(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SP_Lastval.sizePolicy().hasHeightForWidth())
        self.SP_Lastval.setSizePolicy(sizePolicy)
        self.SP_Lastval.setOrientation(QtCore.Qt.Vertical)
        self.SP_Lastval.setObjectName("SP_Lastval_6")
        self.label_name_Lastval = QtWidgets.QLabel(self.SP_Lastval)
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(9)
        self.label_name_Lastval.setFont(font)
        self.label_name_Lastval.setObjectName("label_name_Lastval_6")
        self.label_Lastval = QtWidgets.QLabel(self.SP_Lastval)
        font = QtGui.QFont()
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.label_Lastval.setFont(font)
        self.label_Lastval.setObjectName("label_Lastval_6")
        self.horizontalLayout_4.addWidget(self.SP_Lastval)
        self.verticalLayout_3.addLayout(self.horizontalLayout_4)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setContentsMargins(-1, 5, 40, -1)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.TB_LPersCommentAssessment = QtWidgets.QToolButton(self.frame)
        self.TB_LPersCommentAssessment.setMinimumSize(QtCore.QSize(25, 25))
        self.TB_LPersCommentAssessment.setStyleSheet("\n"
                                                           "border:none\\n")
        self.TB_LPersCommentAssessment.setIcon(icon4)
        self.TB_LPersCommentAssessment.setIconSize(QtCore.QSize(30, 30))
        self.TB_LPersCommentAssessment.setCheckable(False)
        self.TB_LPersCommentAssessment.setObjectName("label_LPersCommentAssessment_15")
        self.horizontalLayout_2.addWidget(self.TB_LPersCommentAssessment)
        self.TB_LPersUserAssessment = QtWidgets.QToolButton(self.frame)
        self.TB_LPersUserAssessment.setMinimumSize(QtCore.QSize(25, 25))
        self.TB_LPersUserAssessment.setStyleSheet("\n"
                                                     "border:none\\n")
        self.TB_LPersUserAssessment.setIcon(icon5)
        self.TB_LPersUserAssessment.setIconSize(QtCore.QSize(30, 30))
        self.TB_LPersUserAssessment.setCheckable(False)
        self.TB_LPersUserAssessment.setObjectName("label_LPersUserAssessment")
        self.horizontalLayout_2.addWidget(self.TB_LPersUserAssessment)
