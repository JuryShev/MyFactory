...
def start_process(progress_bar, self=None):
    ...
    thred_progress_bar = mw.Worker_2(
...
class MainWindow_all_3(QtWidgets.QMainWindow):
    ...
    def edit_personal(self):
        ...
        dlg.LE_Attestation.setText(
            self._translate("Form", str(self.PersonalDataGet["tables"]["personal"][0]['certification'])))
    ...
    def get_personal(self, NamePerson):
        ...
        if index != -1:
            ...
            self.WorkWindow.label_asses_certification.setText(
                self._translate("MainWindow", str(person["certification"])))
            ...
            self.WorkWindow.label_birthday.setText(
                self._translate("MainWindow", day + ' ' + rev_month[month] + ' ' + year + ' года'))
